...
type R = { id: number; name: string; max_bags: number | null };
...
export default function PackPage() {
  ...
  async function run() {
    ...
    try {
      ...
      setBags(out);
      setMsg(`完成装袋：${out.length} 袋${route?.max_bags != null ? ` / 上限 ${route.max_bags}` : ""}`);
  ...
  return (<>
    ...
    <div className="toolbar">
      ...
      <span className="mono">袋数上限：{route?.max_bags ?? "不限"}</span>
